...
const nativeIntegrations = [
  { icon: '📧', name: 'Gmail', desc: 'Reads, replies, sends and organises your emails. Never miss an important message.', examples: ['Reply to customer enquiries within seconds', 'Send quotes and invoices by email', 'Organise inbox with labels', 'Follow up on leads automatically', 'Draft emails from a voice command', 'Flag and alert you about urgent messages'], works: 'One-click authorise — we handle the rest' },
  { icon: '📅', name: 'Google Calendar', desc: 'Books appointments, reschedules meetings and sends reminders — all from a simple conversation.', examples: ['Book client appointments automatically', 'Set job reminders and deadlines', 'Reschedule without back-and-forth', 'Check availability before confirming jobs', 'Send calendar invites to clients', 'Block travel time between jobs'], works: 'One-click authorise — we handle the rest' },
  { icon: '📁', name: 'Google Drive', desc: 'Save, find and share files in your Drive. No more hunting for documents.', examples: ['Save client documents automatically', 'Find old quotes in seconds', 'Share files with clients via link', 'Organise folders by client or job', 'Upload job photos', 'Create folders for new clients'], works: 'One-click authorise — we handle the rest' },
  { icon: '📊', name: 'Google Sheets', desc: 'Reads and updates your spreadsheets. Track leads, jobs, stock or anything else.', examples: ['Update job trackers in real time', 'Log new leads automatically', 'Read price lists when quoting', 'Track expenses and costs', 'Generate weekly summaries', 'Flag rows that need attention'], works: 'One-click authorise — we handle the rest' },
  { icon: '📝', name: 'Google Docs', desc: 'Writes, reads and updates your documents. Perfect for proposals, reports and templates.', examples: ['Draft client proposals from a voice note', 'Update SOPs automatically', 'Write job reports', 'Fill in your own templates', 'Summarise long documents', 'Create instant meeting notes'], works: 'One-click authorise — we handle the rest' },
  { icon: '👥', name: 'Google Contacts', desc: 'Look up, add and update your contacts. Always know who you\'re dealing with.', examples: ['Look up client details instantly', 'Add new contacts from emails', 'Update phone numbers and addresses', 'Find past clients by name or job', 'Merge duplicate contacts', 'Tag contacts by category'], works: 'One-click authorise — we handle the rest' },
  { icon: '✅', name: 'Google Tasks', desc: 'Create, manage and complete tasks through your agent. Your to-do list, handled.', examples: ['Create tasks from emails automatically', 'Set job deadlines', 'Mark tasks complete via Telegram', 'Daily task summaries', 'Organise by project', 'Remind you of overdue items'], works: 'One-click authorise — we handle the rest' },
  { icon: '📋', name: 'Google Forms', desc: 'Capture form responses and act on them instantly — follow-ups, alerts, logging.', examples: ['Get notified when a form is submitted', 'Extract client details from responses', 'Auto-reply to new enquiries', 'Add form data to your CRM sheet', 'Trigger follow-up emails', 'Weekly response summaries'], works: 'One-click authorise — we handle the rest' },
