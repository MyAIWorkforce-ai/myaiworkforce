...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    title: 'Build My Agent | $497 Setup + First Month Free | My AI Workforce',
    description: 'Custom AI agent built, deployed and managed for your business. Live in 24 hours. $497 setup + first month free.',
  },
}
