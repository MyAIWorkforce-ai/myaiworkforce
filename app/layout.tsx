...
export const metadata: Metadata = {
  ...
  description:
    "Build your AI workforce without the complexity. Browse 500+ ready-made AI agents, grab a DIY guide, or let our team build, deploy and manage your entire AI workforce — from $199/mo USD.",
  ...
  twitter: {
    ...
    title: "Build Your AI Workforce Without the Complexity | MyAIWorkforce.ai",
    description: "Browse 500+ ready-made AI agents or let us build your entire AI workforce from $199/mo USD.",
  },
};
