  ...
  return (
    <header className="sticky top-0 z-50 border-b" style={{ backgroundColor: "var(--nav-bg)", borderColor: "var(--nav-border)" }}>
      <div className="max-w-6xl mx-auto px-6 flex items-center justify-between h-16">
        <a href="/" className="font-bold text-xl" style={{ color: "var(--yellow)" }}>My AI Workforce</a>
        <nav className="hidden md:flex items-center gap-8 text-sm font-medium">
          <a href="/marketplace" style={{ color: "var(--yellow)" }}>Marketplace</a>
          <a href="/guides" style={{ color: "var(--text-dim)" }}>Guides</a>
          <a href="/pricing" style={{ color: "var(--text-dim)" }}>Pricing</a>
        </nav>
        <a href="/contact" className="px-4 py-2 rounded-lg font-semibold text-sm" style={{ backgroundColor: "var(--yellow)", color: "#0A0A0A" }}>Book a Call</a>
      </div>
    </header>
  );
}
