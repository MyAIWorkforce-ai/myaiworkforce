...
export default function InternalDomainsPage() {
  ...
  const keepDomains = domains.filter(d => (selections[d.name] || d.defaultStatus) === 'keep');
  const reviewDomains = domains.filter(d => (selections[d.name] || d.defaultStatus) === 'review');
